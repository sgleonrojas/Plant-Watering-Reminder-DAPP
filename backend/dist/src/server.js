...
function validatePlantData(data) {
    console.log('Validating plant data:', JSON.stringify(data, null, 2));
...
app.post('/add_plant', (req, res) => {
    try {
        ...
        // Log complete plant data for debugging
        console.log('Raw request body:', JSON.stringify(req.body, null, 2));
        console.log('Plant data type:', typeof plantData);
        console.log('Plant data keys:', Object.keys(plantData));
